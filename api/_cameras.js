...
export const CCTV_CATALOG = [
  // Austin, TX
  {
    ...
    sourceKind: 'live',
    poseSource: 'catalog',
    license: 'City of Austin Surveillance Grid',
    url: '/cctv/austin_capitol.mp4',
  ...
  // New York, NY
  {
    ...
    sourceKind: 'live',
    poseSource: 'catalog',
    license: 'Operational Port Security Feed',
  ...
  {
    id: 'nyc-times-square',
    name: 'Times Square Central Canyon',
    city: 'New York',
    cityId: 'nyc',
    provider: 'Times Square Alliance',
    lat: 40.7580,
    lon: -73.9855,
    headingDeg: 218,
    headingConfidence: 'high',
    ...
    sourceKind: 'live',
    poseSource: 'catalog',
    license: 'EarthCam Public Feed',
    url: '/cctv/nyc_times_square.mp4',
  ...
  // Tokyo, Japan
  {
    ...
    name: 'Shibuya Crossing Scramble Cam',
    city: 'Tokyo',
    cityId: 'tokyo',
    provider: 'Shibuya City Surveillance Network',
    lat: 35.6595,
    lon: 139.7005,
    headingDeg: 18,
    headingConfidence: 'high',
    ...
    sourceKind: 'live',
    poseSource: 'catalog',
    license: 'Tokyo Metropolitan Government',
    url: '/cctv/tokyo_shibuya.mp4',
    snapshotUrl: '/cctv/tokyo_shibuya.jpg',
  },
  {
    id: 'tokyo-tower-observation',
    name: 'Tokyo Tower Oblique Watch',
    city: 'Tokyo',
    cityId: 'tokyo',
    provider: 'Tokyo Spatial Sensor Network',
    lat: 35.6586,
    lon: 139.7454,
    headingDeg: 0,
    headingConfidence: 'high',
  ...
  // San Francisco, CA
  {
    ...
    sourceKind: 'live',
    poseSource: 'catalog',
    license: 'Caltrans Operational Stream',
  ...
  // London, UK
  {
    ...
    sourceKind: 'live',
    poseSource: 'catalog',
    license: 'TfL Operational Stream',
    url: '/cctv/london_tower_bridge.mp4',
  ...
  // Paris, France
  {
    ...
    name: 'Champ de Mars / Eiffel North',
    city: 'Paris',
    cityId: 'paris',
    provider: 'Ville de Paris Surveillance',
    lat: 48.8584,
    lon: 2.2945,
    headingDeg: 315,
    headingConfidence: 'high',
    ...
    sourceKind: 'live',
    poseSource: 'catalog',
    license: 'Paris Surveillance Network',
    url: '/cctv/paris_eiffel.mp4',
